...
public interface WmsMapper {
  ...
  List<QMS_PROD_CHECK_GET> qmsProdCheckGet(QMS_PROD_CHECK_GET p);
  List<QMS_PROD_CD_GET> qmsProdCdGet(QMS_PROD_CD_GET p);
  List<QMS_PROD_CHECK_ADD> qmsProdCheckAdd(QMS_PROD_CHECK_ADD p);
